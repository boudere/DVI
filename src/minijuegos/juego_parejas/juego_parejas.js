...
// TODO: cuando esté hecha, añadir musica juego parejas en data.json, docs/data.json, folders.json, docs/folders.json y assets/musica
...
class JuegoParejas extends Game {
    ...
    _definicion_parejas() {
        this.parejas = [
            ...
            { id: 2, img1: 'jagger', img2: 'blackout'},
    ...
    _crear_temporizador() {
        this.tiempoRestante = this.TIEMPO_LIMITE;
